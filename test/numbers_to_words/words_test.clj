...
(deftest num-to-words
  ...
  (testing "hundreds place"
    (are [actual expected] (= actual expected)
      [["one" "hundred"]] (number-to-words [1 100])
      [["two" "hundred"]] (number-to-words [2 100])
      [["three" "hundred"]] (number-to-words [3 100])
      [["four" "hundred"]] (number-to-words [4 100])
      [["five" "hundred"]] (number-to-words [5 100])
      [["six" "hundred"]] (number-to-words [6 100])
      [["seven" "hundred"]] (number-to-words [7 100])
      [["eight" "hundred"]] (number-to-words [8 100])
      [["nine" "hundred"]] (number-to-words [9 100]))))
